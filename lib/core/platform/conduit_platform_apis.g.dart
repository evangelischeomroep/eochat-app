...
class PlatformNativeSheetTheme {
  ...
  static PlatformNativeSheetTheme decode(Object result) {
    ...
    return PlatformNativeSheetTheme(
      isDark: result[0]! as bool,
      backgroundArgb: result[1]! as int,
      surfaceArgb: result[2]! as int,
      elevatedSurfaceArgb: result[3]! as int,
      inputArgb: result[4]! as int,
      foregroundArgb: result[5]! as int,
      secondaryForegroundArgb: result[6]! as int,
      iconArgb: result[7]! as int,
      borderArgb: result[8]! as int,
      accentArgb: result[9]! as int,
      onAccentArgb: result[10]! as int,
      destructiveArgb: result[11]! as int,
    );
  }
...
class PlatformNativeSheetModelSelectorRequest {
  ...
  static PlatformNativeSheetModelSelectorRequest decode(Object result) {
    ...
    return PlatformNativeSheetModelSelectorRequest(
      ...
      pinTitle: result[7] as String?,
      unpinTitle: result[8] as String?,
      moreModelsTitle: result[9]! as String,
      searchModelsTitle: result[10]! as String,
