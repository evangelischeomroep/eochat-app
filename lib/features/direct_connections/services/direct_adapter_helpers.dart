  ...
  try {
    while (true) {
      ...
      if (receivedBytes > maxBytes) {
        ...
        throw const DirectProviderException(
          'The provider stream exceeded EOchat\'s transfer limit.',
        );
      }
      if (drainingSuccess) {
...
final class DirectStreamBudget {
  ...
  void addEvent() {
    ...
    if (_events > maxEvents) {
      throw const DirectProviderException(
        'The provider response exceeded EOchat\'s resource limit.',
      );
    }
  }
  ...
  void addCharacters(int characters) {
    ...
    if (_characters > maxCharacters) {
      throw const DirectProviderException(
        'The provider response exceeded EOchat\'s size limit.',
      );
    }
  }
