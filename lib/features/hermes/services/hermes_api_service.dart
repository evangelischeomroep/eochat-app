  ...
  void add(List<int> chunk) {
    ...
    if (_bytes > limits.maxBytes) {
      throw const HermesStreamGuardException(
        'The Hermes stream exceeded EOchat\'s transfer limit.',
      );
    }
  ...
  void _finishLine() {
    if (!_lineHasBytes) {
      ...
      if (_frames > limits.maxRawFrames) {
        throw const HermesStreamGuardException(
          'The Hermes stream exceeded EOchat\'s frame limit.',
        );
      }
    }
    _lineHasBytes = false;
  ...
  try {
    while (true) {
      ...
      if (remaining <= Duration.zero) {
        throw const HermesStreamGuardException(
          'The Hermes stream exceeded EOchat\'s time limit.',
        );
      }
      ...
      if (events > limits.maxEvents) {
        throw const HermesStreamGuardException(
          'The Hermes stream exceeded EOchat\'s event limit.',
        );
      }
      ...
      if (eventCharacters > remainingCharacters) {
        throw const HermesStreamGuardException(
          'The Hermes stream exceeded EOchat\'s size limit.',
        );
      }
  ...
  try {
    ...
    if (data is ResponseBody) {
      ...
      if (advertisedLength != null &&
        ...
        throw const HermesStreamGuardException(
          'The Hermes recovery response exceeded EOchat\'s transfer limit.',
        );
      }
    ...
    if (data is ResponseBody) {
      ...
      if (advertisedLength != null &&
          (advertisedLength > byteLimit ||
              advertisedLength > recoveryBudget.remainingBytes)) {
        throw const HermesStreamGuardException(
          'The Hermes response exceeded EOchat\'s transfer limit.',
        );
      }
      ...
      try {
        ...
        throw HermesStreamGuardException(
          remaining <= idleTimeout
              ? 'The Hermes recovery response exceeded EOchat\'s time limit.'
  ...
  try {
    ...
    throw switch (error.limit) {
      HermesJsonLimit.depth => const HermesStreamGuardException(
        'The Hermes recovery response exceeded EOchat\'s nesting limit.',
      ),
      HermesJsonLimit.nodes => const HermesStreamGuardException(
        'The Hermes recovery response exceeded EOchat\'s value limit.',
      ),
      HermesJsonLimit.tokens => const HermesStreamGuardException(
        'The Hermes recovery response exceeded EOchat\'s token limit.',
      ),
    };
  }
}
  ...
  while (stack.isNotEmpty) {
    ...
    if (value is String) {
      ...
      if (characters > maxCharacters) {
        throw const HermesStreamGuardException(
          'The Hermes recovery response exceeded EOchat\'s size limit.',
        );
      }
      continue;
    }
      ...
      final response = await _dio
          ...
          .timeout(
            ...
            onTimeout: () {
              _signalHermesStreamCancellation(cancelToken);
              throw const HermesStreamGuardException(
                'The Hermes response exceeded EOchat\'s time limit.',
              );
            },
          );
      recoveryBudget.requireRemainingDuration();
      ...
      final response = await _dio
          ...
          .timeout(
            ...
            onTimeout: () {
              ...
              throw const HermesStreamGuardException(
                'The Hermes create response exceeded EOchat\'s time limit.',
              );
            },
          );
...
List<Map<String, dynamic>> _boundedHermesMapList(
  ...
  if (candidate.length > kMaxHermesJsonCollectionItems) {
    throw const HermesStreamGuardException(
      'The Hermes response exceeded EOchat\'s item limit.',
    );
  }
  return candidate
      .whereType<Map>()
